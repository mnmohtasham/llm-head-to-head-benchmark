...
import { E2E_AGENT_PORTS, E2E_APP_PORT, E2E_MOCK_PORTS } from './ports';
...
export default defineConfig({
  ...
  webServer: {
    command: `npx tsx scripts/demo.ts --port ${E2E_APP_PORT} --mock-ports ${E2E_MOCK_PORTS.join(',')} --agent-ports ${E2E_AGENT_PORTS.join(',')} --data-dir e2e/.data --no-seed`,
    cwd: root,
